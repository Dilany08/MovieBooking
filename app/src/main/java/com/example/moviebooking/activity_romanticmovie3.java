...
public class activity_romanticmovie3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_romanticmovie3);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(activity_romanticmovie3.this, genre2.class);
                Toast.makeText(activity_romanticmovie3.this, "Returning...", Toast.LENGTH_SHORT).show();
