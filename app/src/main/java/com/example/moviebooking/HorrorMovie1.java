...
public class HorrorMovie1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_horror_movie1);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(HorrorMovie1.this, genre3.class);
                Toast.makeText(HorrorMovie1.this, "Returning...", Toast.LENGTH_SHORT).show();
