...
public class activity_romanticmovie2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_romanticmovie2);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(activity_romanticmovie2.this, genre2.class);
                Toast.makeText(activity_romanticmovie2.this, "Returning...", Toast.LENGTH_SHORT).show();
        ...
        timebtn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(activity_romanticmovie2.this,TransactionPage.class);
